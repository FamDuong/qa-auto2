...
# CocCoc Shopping RungRinh
COCCOC_SHOPPING_DB_SERVER = get_environment_info()['coccoc_shopping']['db_info']['server']
COCCOC_SHOPPING_DB_NAME = get_environment_info()['coccoc_shopping']['db_info']['database_name']
COCCOC_SHOPPING_DB_USERNAME = get_environment_info()['coccoc_shopping']['db_info']['username']
COCCOC_SHOPPING_DB_PASSWORD = get_environment_info()['coccoc_shopping']['db_info']['password']
