...
class AnySite(object):
    ...
    TV_HAY_VN_PLAY_BTN = (By.XPATH, '//div[@class="vid_play"]')
    TV_HAY_VN_IFRAME_LEVEL_1 = (By.XPATH, '//iframe[@width="100%"]')
    TV_HAY_VN_IFRAME_LEVEL_2 = (By.XPATH, '//iframe[@width="100%"]')
    TV_HAY_VN_SKIP_ADD_BTN = (By.XPATH, '//span[text()="Bỏ qua quảng cáo"]')
    TV_HAY_VN_VIDEO_ITEM = (By.XPATH, '//div[@id="media"]')
