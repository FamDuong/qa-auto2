...
class TopSitesSaviorTitleElements(BasePageElement):
    ...
    def find_tiktok_video_title_element(self, driver):
        return self.wait_for_element(driver).until(ec.presence_of_element_located(TopSaviorSitesTitleLocators.TIKTOK_VIDEO_TITLE))
