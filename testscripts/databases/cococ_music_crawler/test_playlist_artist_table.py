...
def test_playlist_id(cococ_music_crawler_db_interact):
    null_or_empty_value = cococ_music_crawler.check_if_value_null_or_empty_in_column(cococ_music_crawler_db_interact
                                                                                     , 'playlist_id', 'playlist_artist')
    one_row_result = cococ_music_crawler.get_one_result_from_table(cococ_music_crawler_db_interact, 'playlist_artist')
    ...
    one_row_result_table_playlists = cococ_music_crawler.get_one_result_from_table_with_condition \
        (cococ_music_crawler_db_interact
         , 'playlist_id', playlist_id
         , 'playlists')
    one_row_result_table_playlist_category = cococ_music_crawler.get_one_result_from_table_with_condition(
        cococ_music_crawler_db_interact, 'playlist_id', playlist_id, 'playlist_category'
    )
...
def test_artist_id(cococ_music_crawler_db_interact):
    null_or_empty_artist_id = cococ_music_crawler.check_if_value_null_or_empty_in_column(
        cococ_music_crawler_db_interact, 'artist_id'
        , 'playlist_artist')
    one_row_result = cococ_music_crawler.get_one_result_from_table(cococ_music_crawler_db_interact, 'playlist_artist')
    ...
    one_row_result_artists_table = cococ_music_crawler.get_one_result_from_table_with_condition(
        cococ_music_crawler_db_interact, 'artist_id', artist_id, 'artists'
    )
    one_row_result_song_artist_table = cococ_music_crawler.get_one_result_from_table_with_condition(
        cococ_music_crawler_db_interact, 'artist_id', artist_id, 'song_artist'
    )
...
def test_create_time(cococ_music_crawler_db_interact):
    row = cococ_music_crawler.get_one_result_from_table(cococ_music_crawler_db_interact, 'playlist_artist')
