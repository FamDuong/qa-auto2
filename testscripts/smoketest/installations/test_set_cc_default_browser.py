...
class TestCcDefaultBrowser:
    ...
    def test_check_if_user_can_set_cc_default_browser_setting_page(self,
    ...
    @pytestrail.defect('BR-1133')
    @pytest.mark.skip(reason='set_chrome_default_browser() funtion is not work, take time to set default browser')
    def test_set_default_browser_coccoc_then_change_default_browser_to_chrome(self):
        from testscripts.smoketest.common import uninstall_old_version_remove_local_app, install_coccoc_set_as_default
    ...
    def test_check_if_dialog_coccoc_is_not_your_default_after_1_month(self):
        from testscripts.smoketest.common import uninstall_old_version_remove_local_app, install_coccoc_not_set_as_default
        uninstall_old_version_remove_local_app()
